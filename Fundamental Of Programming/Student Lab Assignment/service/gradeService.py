...
class gradeService:
    ...
    def add_grade(self, student_id, assignment_id, student_grade):
        ...
        undo_function = FunctionCall(self.grade_list.update_grade, index, None)
        redo_function = FunctionCall(self.grade_list.update_grade, index, student_grade)
        operation = OperationCall(undo_function, redo_function)
        self._undo_service.record(operation)


        self.grade_list.update_grade(index, student_grade)
    ...
    def give_assignment(self, student_id, assignment_id, student_grade= None):
        ...
        undo_function = FunctionCall(self.grade_list.delete_grade, new_grade)
        redo_function = FunctionCall(self.grade_list.add_grade, new_grade)
        operation = OperationCall(undo_function, redo_function)
        self._undo_service.record(operation)

        #----------------------------------------------------------
        self.grade_list.add_grade(new_grade)
