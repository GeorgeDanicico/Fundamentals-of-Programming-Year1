...
class studentService:
    ...
    def add_student(self, id, name, group):
        ...
        undo_function = FunctionCall(self.student_list_service.remove_object, student)
        redo_function = FunctionCall(self.student_list_service.add_object, student)
    ...
    def remove_student(self, id):
        ...
        # UNDO STARTS HERE ----------------------------------------
        undo_function = FunctionCall(self.student_list_service.add_object, student)
        redo_function = FunctionCall(self.student_list_service.remove_object, student)
        operation = OperationCall(undo_function, redo_function)
        ...
        while index < (len(self.student_grade_service)):
            if self.student_grade_service[index].student_id == student.student_id:
                ...
                undo_function = FunctionCall(self.student_grade_service.add_object, self.student_grade_service[index])
                redo_function = FunctionCall(self.student_grade_service.remove_object, self.student_grade_service[index])
                operation = OperationCall(undo_function, redo_function)
                ...
                self.student_grade_service.remove_object(self.student_grade_service[index])
                index -= 1
            index += 1
        ...
        self.student_list_service.remove_object(self.student_list_service[student_index])
    ...
    def update_student(self, id, group):
        ...
        undo_function = FunctionCall(self.student_list_service.update_object, student_index, previous_group)
        redo_function = FunctionCall(self.student_list_service.update_object, student_index, group)
        operation = OperationCall(undo_function, redo_function)
        self._undo_service.record(operation)


        self.student_list_service.update_object(student_index, group)
