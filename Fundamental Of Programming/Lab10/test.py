...
class TestAssignment(unittest.TestCase):
    ...
    def test_add_assignment_repo(self):
        ...
        assing1 = Assignment('123', 'Homework due Tomorrow', '2021-12-22')
        self.assing_repo.add_object(assing1)
        assing2 = Assignment('124', 'Homework due Tomorrow', '2021-12-22')
        self.assing_repo.add_object(assing2)
        assing3 = Assignment('125', 'Homework due Tomorrow', '2021-12-22')
        self.assing_repo.add_object(assing3)
        assing4 = Assignment('126', 'Homework due Tomorrow', '2021-12-22')
        self.assing_repo.add_object(assing4)
    ...
    def test_remove_assignment_repo(self):
        assing = Assignment('123', 'Homework due Tomorrow', '2021-12-22')
        self.assing_repo.add_object(assing)
